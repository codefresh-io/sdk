...
class Clusters extends Resource {
    async create(info) {
        const dirPath = `${CODEFRESH_PATH}/cluster`;
        const filePath = `${CODEFRESH_PATH}/cluster/stevedore`;
        const versionPath = `${CODEFRESH_PATH}/cluster/version.txt`;
        const versionUrl = 'https://raw.githubusercontent.com/codefresh-io/Stevedore/master/VERSION';
        let zipPath = `${CODEFRESH_PATH}/cluster/data`;
